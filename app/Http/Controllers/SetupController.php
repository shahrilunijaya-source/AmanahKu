...
class SetupController extends Controller
{
    ...
    public function stepDefs(): array
    {
        $defs = [
            ...
            'work_week' => ['label' => 'Set work week', 'label_ms' => 'Tetapkan minggu bekerja', 'desc' => 'Which days count as working days. Leave, timesheets and attendance follow this.', 'screen' => 'settings', 'query' => ['section' => 'work_week'], 'auto' => false, 'domain' => 'basics', 'critical' => false],
