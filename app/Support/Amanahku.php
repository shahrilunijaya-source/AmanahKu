...
class Amanahku
{
    ...
    public static function page(string $screen): array
    {
        $pages = [
            ...
            'team-board' => ['title' => 'Team Board — All Tasks', 'title_ms' => 'Papan Pasukan — Semua Tugasan', 'sub' => 'Every staff member\'s tasks, assignments and adhoc work — company-wide.', 'sub_ms' => 'Tugasan, penugasan dan kerja adhoc setiap staf — seluruh syarikat.', 'crumb' => ['My Work', 'Team Board']],
            ...
            'position' => ['title' => 'Position & Manday Rates', 'title_ms' => 'Jawatan & Kadar Manday', 'sub' => 'Salary bands per position — drive manday/manhour costing on timesheets.', 'sub_ms' => 'Jadual gaji mengikut jawatan, memacu kos manday/manhour pada timesheet.', 'crumb' => ['Administration', 'Position & Manday Rates']],
            ...
            'settings' => ['title' => 'Company Settings', 'title_ms' => 'Tetapan Syarikat', 'sub' => 'Workspace profile, statutory numbers, branches and departments.', 'sub_ms' => 'Profil ruang kerja, nombor berkanun, cawangan dan jabatan.', 'crumb' => ['Administration', 'Company Settings']],
    ...
    public static function crumbMap(): array
    {
        return [
            ...
            'Position & Manday Rates' => 'Jawatan & Kadar Manday',
            'Roster' => 'Jadual Syif',
