...
class CreateExternalTotEventTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        return $this->preview(
            $httpRequest,
            $payload,
            "Post the External TOT event '".$data['title']."' on ".$data['event_date'].'. No employees will be tagged or notified.',
