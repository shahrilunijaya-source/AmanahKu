...
import { registerTimesheetApprovals } from './timesheet-approvals';
...
import { registerExternalTotPaste } from './external-tot-paste';
import { registerFridaySignOff } from './friday-signoff';
import { registerTotAction } from './tot-action';
import { registerTotCard } from './tot-card';
import { registerTotRoster } from './tot-roster';
import { registerTotSlotThread } from './tot-slot-thread';
...
registerTimesheetApprovals(Alpine);
...
registerExternalTotPaste(Alpine);
registerFridaySignOff(Alpine);
registerTotCard(Alpine);
registerTotRoster(Alpine);
registerTotAction(Alpine);
registerTotSlotThread(Alpine);
