...
<head>
    ...
    <title>Confirm password · Amanahku</title>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:var(--canvas);padding:48px;">
    <form action="{{ route('password.confirm.store') }}" method="post" style="width:100%;max-width:380px;">
        @csrf
        ...
        <h1 style="font-weight:400;font-size:28px;letter-spacing:-0.5px;color:var(--ink);margin:0 0 8px;">Confirm your password</h1>
        <p style="font-size:14px;color:var(--muted);margin:0 0 28px;">This is a secured area. Re-enter your password to continue.</p>
        ...
        <input name="password" type="password" autocomplete="current-password" required autofocus style="{{ $fs }}" />

        <button type="submit" class="uj-btn-primary" style="width:100%;height:46px;font-size:14px;margin-top:2px;">Confirm</button>
    </form>
</div>
</body>
</html>
