        ...
        @if ($privileged)
            <div class="uj-card" style="padding:20px;">
                ...
                <form method="post" action="{{ route('events.store') }}">
                    ...
                    <label style="display:block;font-size:12.5px;font-weight:500;color:var(--ink);margin-bottom:5px;"><span x-text="$store.ui.lang==='en' ? 'Time' : 'Masa'">Time</span> <span style="color:var(--muted);font-weight:400;" x-text="$store.ui.lang==='en' ? '(optional)' : '(pilihan)'">(optional)</span></label>
                    ...
                    <label style="display:block;font-size:12.5px;font-weight:500;color:var(--ink);margin-bottom:5px;"><span x-text="$store.ui.lang==='en' ? 'Location' : 'Lokasi'">Location</span> <span style="color:var(--muted);font-weight:400;" x-text="$store.ui.lang==='en' ? '(optional)' : '(pilihan)'">(optional)</span></label>
                    ...
                    <label style="display:block;font-size:12.5px;font-weight:500;color:var(--ink);margin-bottom:5px;"><span x-text="$store.ui.lang==='en' ? 'Description' : 'Penerangan'">Description</span> <span style="color:var(--muted);font-weight:400;" x-text="$store.ui.lang==='en' ? '(optional)' : '(pilihan)'">(optional)</span></label>
