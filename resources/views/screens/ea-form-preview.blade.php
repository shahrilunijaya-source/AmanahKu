...
@php $eaIsHr = in_array(\App\Support\Permissions::effectiveRole((string) request()->attributes->get('tenantRole', 'employee')), ['management', 'hr'], true); @endphp
<a href="{{ $eaIsHr ? route('app.screen', ['screen' => 'payroll-review', 'tab' => 'ea-form']) : route('app.screen', ['screen' => 'payroll-my', 'tab' => 'ea-form']) }}" style="display:inline-flex;align-items:center;gap:6px;font-size:13px;color:var(--muted);text-decoration:none;margin-bottom:16px;">
