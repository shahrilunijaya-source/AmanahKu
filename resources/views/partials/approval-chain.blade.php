...
@endphp
@if ($compact)
    {{-- Compact horizontal variant — claims screen only, as a footer strip below the claim
         rows where the tall stacked panel would be too much vertical weight. Leave and
         overtime don't pass $compact, so they keep the tall layout below unchanged. --}}
    <div style="display:flex;gap:20px;flex-wrap:wrap;align-items:flex-start;">
        ...
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" style="color:var(--muted);align-self:center;flex-shrink:0;"><path d="M9 6l6 6-6 6" /></svg>
