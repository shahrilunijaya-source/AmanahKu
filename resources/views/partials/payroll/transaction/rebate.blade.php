            ...
            <tbody>
                @foreach ($zakatRows as $s)
                    <tr>
                        ...
                        <td style="{{ $td }}text-align:right;font-family:var(--font-mono);">{{ number_format((float) $s->zakat_monthly, 2) }}</td>
