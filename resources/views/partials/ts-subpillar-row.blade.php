{{-- One sub-pillar row. Tenant-wide: it applies to every project, not to one.
     ...
     (SubPillar) and $canEdit. --}}
@php $canEdit = $canEdit ?? false; @endphp
<div style="display:flex;flex-wrap:wrap;align-items:center;gap:12px;padding:11px 0;border-bottom:1px solid var(--hairline-soft);" x-data="{ se: false }">
